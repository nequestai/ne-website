...
const FeatureSection = () => (
  <section id="team" className="bg-white pb-6">
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      <div className="container mx-auto md:px-6 md:p-6 bg-white">
        <div className="mb-16 text-center">
          <h4 className="text-base text-indigo-600 font-semibold tracking-wide uppercase">ABOUT US</h4>
        ...
        <div className="grid grid-rows-15 grid-cols-10 gap-2 md:h-64 md:my-32 text-white md:text-black">
          <div
