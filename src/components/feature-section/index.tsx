        ...
        <div className="flex flex-wrap my-12">
          <div className="w-full border-b md:w-1/2 md:border-r lg:w-1/3 p-8">
            <div className="flex items-center mb-6">
              ...
              <div className="ml-4 text-xl">Quantifiable Results</div>
            </div>
          ...
          <div className="w-full border-b md:w-1/2 lg:w-1/3 lg:border-r p-8">
            <div className="flex items-center mb-6">
              <Check width={20} height={20} fill="currentColor" className="h-6 w-6 text-indigo-500" />
              <div className="ml-4 text-xl">Fully Remote</div>
            </div>
            <p className="leading-loose text-gray-500 ">
          ...
          <div className="w-full border-b md:w-1/2 md:border-r lg:w-1/3 lg:border-r-0 p-8">
            <div className="flex items-center mb-6">
              <Check width={20} height={20} fill="currentColor" className="h-6 w-6 text-indigo-500" />
              <div className="ml-4 text-xl">Built by doctors for doctors</div>
            </div>
            <p className="leading-loose text-gray-500">
