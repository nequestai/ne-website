  ...
  <section className="lg:py-18 pt-16 overflow-hidden">
    <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 bg-white">
      <div id="about" className="text-center">
        ...
        <p className="mt-2 pb-4 text-5xl lg:text-7xl font-bold tracking-tight text-gray-900">We can do better</p>
      </div>
      <div className="flex flex-wrap -mx-8 items-center">
        ...
        <div className="w-full lg:w-1/2 p-12 md:p-24">
      ...
      <div className="text-center mt-16">
        <p className="text-gray-500 text-lg m-12 p-12 rounded-lg leading-relaxed bg-blue-100">
